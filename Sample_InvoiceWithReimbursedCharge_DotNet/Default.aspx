    ...
    <body>
        <form id="form1" runat="server">
            <div id="intro" runat="server">
                <h4>"This sample app demonstartes a workflow for Billable expenses (Reimbursed charge) and Invoices, . To read more about it go to: <a href='https://developer.intuit.com/hub/blog/2017/06/21/reimburse-charge-support-quickbooks-online-api'>blog on Reimbursed Charge</a></h4>
                <p>Make sure that your app's Client Id, Client Secret, Redirect Url, App Environment and logPath in Web.config file</p>
            </div>
            <div id="oauth" runat="server" visible ="false">
                <!-- OAuth flow -->
                <asp:ImageButton id="btnOAuth" runat="server" AlternateText="OAuth"
                       ImageAlign="left"
                       ImageUrl="Images/C2QB_white_btn_lg_default.png"
                        CssClass="font-size:14px; border: 1px solid grey; padding: 10px; color: red" Height="40px" Width="200px" OnClick="ImgOAuth_Click"/>
                    <br /><br /><br />   
            </div>
            <div id="connected" runat="server" visible ="false">
                ...
                <p>
                    <asp:Label runat="server">"The flow showed in this sample app is as follows."</asp:Label>
                    ...
                    <asp:ListBox runat="server" ID="Label2" Height="150px" >
                        ...
                        <asp:ListItem Text="4. Enter a valid email to send this linked invoice to be sent to that email.The code can be changed to take in the customer's email" />
                ...
                <p>
                    <asp:label runat="server" id="linkInvoiceMessage" visible="true">Please link expense and invoice with ids shown above via UI.</asp:label>
                </p> 
                <br /><br />
